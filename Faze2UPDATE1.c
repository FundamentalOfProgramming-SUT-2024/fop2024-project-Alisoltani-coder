...
void connect_to_db()
{
    ...
    /*if (mysql_real_connect(conn, "localhost", "root", "", "GameData", 0, NULL, 0) == NULL)
    {
    ...
    void ScoreBoard()
{
    ...
    void Fight_Room()
    {
        ...
        attroff(COLOR_PAIR(1) | A_BOLD);
        //
        mvprintw(rows + 1, 0, "%ls  %d                           %d                                              %ls  %d     %ls  %d                                                                              %ls  %d",
        messag1, playerGOLD,move_allow, messag3, AncientKeys - UsedKey, messag4, MovesTillLastFood, messag6, level);
